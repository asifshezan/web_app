    ...
    <div class="col-md-8">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>Resort Information</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>Details :</th>
                                    <td>{{ Str::limit($data['resort_detail'],50) }}</td>
                                </tr>
                                <tr>
                                    <th>Image :</th>
                                    <td>
                                        @if ($data -> resort_image != '')
                                            <img src="{{ asset('uploads/resort/' . $data->resort_image) }}" height="60">
                                            @else
